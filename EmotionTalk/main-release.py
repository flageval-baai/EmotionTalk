...
if __name__ == '__main__':
    ...
    # Params for datasets
    parser.add_argument('--dataset', type=str, default='mm4', help='dataset')
    ...
    parser.add_argument('--audio_feature', type=str, default='chatglm2-6b-UTT', help='audio feature name')
    parser.add_argument('--text_feature',  type=str, default='chatglm2-6b-UTT', help='text feature name')
    parser.add_argument('--video_feature', type=str, default='chatglm2-6b-UTT', help='video feature name')
    parser.add_argument('--feat_type',  type=str, default='frm_align', help='feature type [utt, frm_align, frm_unalign]')
    ...
    parser.add_argument('--model', type=str, default='attention', help='model name for training [mlp, attention, and others from MMSA toolkits]')
...
# python -u main-release.py --model='mult'        --feat_type='frm_align'   --dataset='mm4' --audio_feature='chinese-hubert-base-FRA' --text_feature='Baichuan-7B-FRA' --video_feature='clip-vit-large-patch14-FRA' --gpu=1
# python -u main-release.py --model='mfn'         --feat_type='frm_align'   --dataset='mm7' --audio_feature='chinese-hubert-base-FRA' --text_feature='Baichuan-7B-FRA' --video_feature='clip-vit-large-patch14-FRA' --gpu=0
# python -u main-release.py --model='graph_mfn'   --feat_type='frm_align'   --dataset='mm7' --audio_feature='chinese-hubert-base-FRA' --text_feature='Baichuan-7B-FRA' --video_feature='clip-vit-large-patch14-FRA' --gpu=0
# python -u main-release.py --model='mfm'         --feat_type='frm_align'   --dataset='mm7' --audio_feature='chinese-hubert-base-FRA' --text_feature='Baichuan-7B-FRA' --video_feature='clip-vit-large-patch14-FRA' --gpu=0
# python -u main-release.py --model='mctn'        --feat_type='frm_align'   --dataset='mm7' --audio_feature='chinese-hubert-base-FRA' --text_feature='Baichuan-7B-FRA' --video_feature='clip-vit-large-patch14-FRA' --gpu=0
...
# python -u main-release.py --model='lmf'         --feat_type='utt'         --dataset='MM' --audio_feature='chinese-hubert-base-UTT' --text_feature='Baichuan-7B-UTT' --video_feature='clip-vit-large-patch14-UTT' --gpu=1
...
# python -u main-release.py --model='lmf'         --feat_type='utt'         --dataset='MM' --audio_feature='chinese-hubert-base-UTT' --text_feature='Baichuan-7B-UTT' --video_feature='clip-vit-large-patch14-UTT' --gpu=1
# python -u main-release.py --model='lmf'         --feat_type='utt'         --dataset='MM' --audio_feature='chinese-hubert-large-UTT' --text_feature='chinese-roberta-wwm-ext-UTT' --video_feature='dinov2-giant-UTT' --gpu=1
# python -u main-release.py --model='lmf'         --feat_type='utt'         --dataset='MM' --audio_feature='wavlm-large-UTT' --text_feature='chinese-roberta-wwm-ext-large-UTT' --video_feature='dinov2-large-UTT' --gpu=1
# python -u main-release.py --model='lmf'         --feat_type='utt'         --dataset='MM' --audio_feature='chinese-wav2vec2-large-UTT' --text_feature='chatglm2-6b-UTT' --video_feature='clip-vit-base-patch32-UTT' --gpu=1

# python -u main-release.py --model='lmf'         --feat_type='utt'         --dataset='mm7' --audio_feature='chinese-hubert-large-UTT' --text_feature='chinese-roberta-wwm-ext-UTT' --video_feature='dinov2-giant-UTT' --gpu=1
# python -u main-release.py --model='lmf'         --feat_type='utt'         --dataset='mm7' --audio_feature='wavlm-large-UTT' --text_feature='chinese-roberta-wwm-ext-large-UTT' --video_feature='dinov2-large-UTT' --gpu=1
# python -u main-release.py --model='lmf'         --feat_type='utt'         --dataset='mm7' --audio_feature='chinese-wav2vec2-large-UTT' --text_feature='chatglm2-6b-UTT' --video_feature='clip-vit-base-patch32-UTT' --gpu=1

# python -u main-release.py --model='lmf'         --feat_type='utt'         --dataset='mm4' --audio_feature='chinese-hubert-large-UTT' --text_feature='chinese-roberta-wwm-ext-UTT' --video_feature='dinov2-giant-UTT' --gpu=1
# python -u main-release.py --model='lmf'         --feat_type='utt'         --dataset='mm4' --audio_feature='wavlm-large-UTT' --text_feature='chinese-roberta-wwm-ext-large-UTT' --video_feature='dinov2-large-UTT' --gpu=1
# python -u main-release.py --model='lmf'         --feat_type='utt'         --dataset='mm4' --audio_feature='chinese-wav2vec2-large-UTT' --text_feature='chatglm2-6b-UTT' --video_feature='clip-vit-base-patch32-UTT' --gpu=1