...
DATA_DIR = {
    ...
    'IEMOCAPFour':  '/mnt/real_sda/sunhaoqin_space/code/MERTools-master/MERBench/dataset/iemocap-process',
    'IEMOCAPSix':  '/mnt/real_sda/sunhaoqin_space/code/MERTools-master/MERBench/dataset/iemocap-process',
...
PATH_TO_FFMPEG = '/mnt/real_sda/sunhaoqin_space/code/ffmpeg-4.4.1-i686-static/ffmpeg'
