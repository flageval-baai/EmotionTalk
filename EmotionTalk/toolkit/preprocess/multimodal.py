...
if __name__ == '__main__':
    ...
    data = np.load('/mnt/real_sda/sunhaoqin_space/code/MERTools-master/MERBench/dataset/sims-process/label.npz', allow_pickle=True)
    a = data['train_corpus']
    b = data['val_corpus']
    c = data['test_corpus']
    print(c)
    # data1 = np.load('/mnt/real_sda/sunhaoqin_space/code/MERTools-master/MERBench/dataset/iemocap-process/label_6way.npz', allow_pickle=True)
    # b = data1['whole_corpus']
    print(data1.files)
    # ## linux
    # data_root = '/mnt/real_sda/sunhaoqin_space/dataset/IEMOCAP_full_release/'
    # save_root = '/mnt/real_sda/sunhaoqin_space/code/MERTools-master/MERBench/dataset/iemocap-process'
