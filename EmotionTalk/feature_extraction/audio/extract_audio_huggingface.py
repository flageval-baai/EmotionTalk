...
# huggingface-cli download --resume-download TencentGameMate/chinese-hubert-large --local-dir chinese-wav2vec2-large
################## Multilingual #################
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='whisper-base', help='feature extractor')
    parser.add_argument('--feature_level', type=str, default='UTTERANCE', help='FRAME or UTTERANCE')
    parser.add_argument('--dataset', type=str, default='mm4', help='input dataset')
    # # ------ 临时测试SNR对于结果的影响 ------
    ...
    # audio_files
    audio_files = glob.glob("/mnt/real_sda/sunhaoqin_space/dataset/Audio/wav/**/*.wav", recursive=True)
    print(save_dir)
