...
# huggingface-cli download --resume-download hfl/chinese-lert-base --local-dir chinese-lert-base
# huggingface-cli download --resume-download bigscience/bloom-7b1 --local-dir bloom-7b1
# huggingface-cli download --resume-download hfl/chinese-roberta-wwm-ext-large --local-dir chinese-roberta-wwm-ext-large
# huggingface-cli download --resume-download baichuan-inc/Baichuan2-13B-Base --local-dir Baichuan2-13B-Base
# python -u extract_text_huggingface.py --dataset=mm4 --feature_level='UTTERANCE' --model_name='chinese-roberta-wwm-ext-large'           --gpu=0
##################### Chinese #####################
...
# python -u extract_text_huggingface.py --dataset=mm4 --feature_level='UTTERANCE' --model_name='vicuna-7b-v0'           --gpu=0
# python -u extract_text_huggingface.py --dataset=mm4 --feature_level='UTTERANCE' --model_name='Qwen2-7B'           --gpu=0

# huggingface-cli download --resume-download lmsys/vicuna-7b-delta-v0 --local-dir vicuna-7b-v0
# huggingface-cli download --resume-download THUDM/chatglm2-6b --local-dir chatglm2-6b
...
##################### LLM #####################
Qwen2_7B  = 'Qwen2-7B' # https://huggingface.co/decapoda-research/llama-7b-hf
