...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='mm', help='input dataset')
    parser.add_argument('--model_name', type=str, default='clip-vit-large-patch14', help='name of pretrained model')
    ...
    if params.model_name in [CLIP_VIT_BASE, CLIP_VIT_LARGE, DATA2VEC_VISUAL, VIDEOMAE_BASE, VIDEOMAE_LARGE]: # from huggingface
        ...
        model_path = os.path.join(config.PATH_TO_PRETRAINED_MODELS, f'transformers/{params.model_name}/model.safetensors')
